  ...
  <el-container>
    <el-main>
      <div class="uploadArea" v-show="showUploadBtn">
        <input type="file" name="file" id="upload" @change="handleChange" accept="application/gzip" />
...
<script lang="ts" setup name="DockerPush">
...
const upload = async (file: File) => {
  ...
  try {
    const res = await getAxios().post('/docker/upload', uploadFormData, {
      headers: {
